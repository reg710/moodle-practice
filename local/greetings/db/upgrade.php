...
function xmldb_local_greetings_upgrade($oldversion) {
    ...
    // Copied from xmld editor on view php code tab.
    // Increase version number in version.php then copy it here.
    if ($oldversion < 2024031500) {
        ...
        upgrade_plugin_savepoint(true, 2024031500, 'local', 'greetings');
    }
